...
names(powcon) <- c("Date","Time","Global_active_power","Global_reactive_power","Voltage","Global_intensity","Sub_metering_1","Sub_metering_2","Sub_metering_3")
twodays <- subset(powcon,powcon$Date=="1/2/2007" | powcon$Date =="2/2/2007")
